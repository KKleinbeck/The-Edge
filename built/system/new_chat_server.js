...
export default class NewChatServer {
  ...
  static async transmitEvent(id, details, config = {}) {
    ...
    switch (id.toUpperCase()) {
      ...
      case "FALL":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/fall.html",
          details,
        );
        break;
      ...
      case "GENERIC DAMAGE":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/generic_damage.html",
          details,
        );
        break;
      case "GRENADE SHEET BASED":
        ...
        html = await renderTemplate(
          "systems/the_edge/templates/chat/grenade-sheet-based.html",
          details,
        );
        break;
      case "GRENADE CONTEXT BASED":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/grenade-context-based.html",
          details,
        );
        break;
      case "HERO TOKEN":
      ...
      case "IMPACT":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/impact.html",
          details,
        );
        break;
      case "MEDICINE":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/medicine.html",
          details,
        );
        break;
      case "POST ITEM":
      ...
      case "POST SKILL":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/skill-description.html",
          details,
        );
        break;
      ...
      case "REROLL":
        html = await renderTemplate(
          "systems/the_edge/templates/chat/reroll-check.html",
          details,
        );
        break;
      case "SHORT REST":
  ...
  static createChatData(content, config = {}) {
    ...
    if ("speaker" in config) chatData.speaker = config.speaker;
    if ("roll" in config) {
