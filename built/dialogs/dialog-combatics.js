        ...
        const buttons = {
            roll: {
                ...
                callback: async (html) => {
                    ...
                    let [crits, damage, diceRes, hits] = await checkData.actor.system.rollAttackCheck(1, modificators.threshold, vantage, checkData.damage);
                    // Apply the damage
                    let details = {
                    ...
                    if (game.combat) {
                        game.the_edge.combatLog.addAction(LocalisationServer.localise("Weapon attack"), hrChange);
                    }
                    else {
